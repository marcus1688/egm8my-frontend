<template>
  <button
    class="w-full bg-black text-white py-3 rounded-lg flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
    :disabled="!isReady"
    @click="login"
    type="button"
  >
...
async function handleSuccess(response) {
  console.log("Google 响应:", response);
